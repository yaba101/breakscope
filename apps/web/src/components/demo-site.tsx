  ...
  return (
    <div className={cn("demo-site", compact && "compact")}>
      ...
      <main className="demo-main">
        ...
        <p>
          Choose the plan that&apos;s right for you. Scale up or down
          <br />
          ...
          {plans.map((plan, index) => (
            <article
              ...
              className={cn(
                "plan-card",
                index === 1 && "featured",
                candidate && index === 1 && "candidate-shift",
              )}
            >
              ...
              <p>
                {index === 0
                  ? "Perfect for trying out Acme Cloud and small projects."
                  : index === 1
              ...
              <button type="button" className={index === 1 ? "primary" : ""}>
                {plan.action}
              </button>
              {candidate && index === 1 && (
                <div className="measure measure-top">24px</div>
              )}
            </article>
          ))}
        </div>
        ...
        <footer>
          <span>
            <Shapes size={12} /> 99.9% uptime SLA
          </span>
          <span>
            <LockKeyhole size={12} /> Secure by design
          </span>
